...
public class EnemyScript : MonoBehaviour 
{
	...
	void fire () {
		...
		tijdelijke_bullet = Instantiate(bullet,enemybulletemittor.transform.position,Quaternion.identity) as GameObject;

		tijdelijke_bullet.transform.Rotate (Vector3.left *90);

		tijdelijke_rigidbody = tijdelijke_bullet.GetComponent<Rigidbody> ();

		tijdelijke_rigidbody.AddForce ( transform.forward * 999);
